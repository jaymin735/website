          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text24">Step 1: Sign Up</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text22">
                      Discover the various tools and functionalities available
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text29">
                      Personalize your profile and settings to suit your
                      preferences.
                    </span>
                  </Fragment>
                )}
