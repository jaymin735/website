        ...
        <div data-thq="thq-navbar-nav" className="navbar8-thq-desktop-menu-elm">
          <nav className="navbar8-thq-links-elm1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text27">#home</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text23">#about</span>
                </Fragment>
              )}
            </a>
            <a
          ...
          <div className="navbar8-thq-buttons-elm1">
            ...
            <button className="navbar8-thq-action2-elm1 thq-button-animated thq-button-outline">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text21">Secondary Action</span>
                  </Fragment>
                )}
              </span>
            </button>
                      ...
                      <div className="navbar8-thq-menu-item-elm2">
                        ...
                        <div className="navbar8-thq-content-elm2">
                          <span className="navbar8-thq-page2-elm1 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text22">About Us</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                      ...
                      <div className="navbar8-thq-menu-item-elm3">
                        ...
                        <div className="navbar8-thq-content-elm3">
                          <span className="navbar8-thq-page3-elm1 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text14">Services</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
