...
const Contact10 = (props) => {
  return (
    <div className="contact10-container1 thq-section-padding">
      <div className="contact10-thq-max-width-elm thq-section-max-width">
        <div className="contact10-thq-content-elm1 thq-flex-row">
          <div className="contact10-thq-content-elm2">
            <h2 className="thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="contact10-text16">Locations</span>
                </Fragment>
              )}
            </h2>
        ...
        <div className="contact10-thq-content-elm3 thq-flex-row">
          <div className="contact10-container2">
            ...
            <h3 className="contact10-text10 thq-heading-3">
              {props.location1 ?? (
                <Fragment>
                  <span className="contact10-text14">global</span>
                </Fragment>
              )}
            </h3>
            <p className="thq-body-large">
          ...
          <div className="contact10-container4">
            ...
            <h3 className="contact10-text12 thq-heading-3">
              {props.location2 ?? (
                <Fragment>
                  <span className="contact10-text18">Cluj - Napoca</span>
                </Fragment>
              )}
            </h3>
            <p className="thq-body-large">
