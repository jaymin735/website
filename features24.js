          ...
          >
            ...
            <div className="features24-thq-content-elm1">
              <h2 className="thq-heading-2">
                {props.feature1Title ?? (
                  <Fragment>
                    <span className="features24-text6">Our Story</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.feature1Description ?? (
                  <Fragment>
                    <span className="features24-text3">
                     Founded in 2008, Angel Wing International has grown from a single boutique restaurant into a global hospitality brand with award-winning establishments across three continents.
                    </span>
                  </Fragment>
                )}
              </span>
          ...
          >
            ...
            <div className="features24-thq-content-elm2">
              <h2 className="thq-heading-2">
                {props.feature2Title ?? (
                  <Fragment>
                    <span className="features24-text2">Our Philosophy</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
                {props.feature2Description ?? (
                  <Fragment>
                    <span className="features24-text5">
                      Centers on the harmonious blend of culinary innovation, impeccable service, and sustainable practices. We believe that dining should be an extraordinary experience that engages all the senses.
                    </span>
                  </Fragment>
                )}
              </span>
          ...
          >
            ...
            <div className="features24-thq-content-elm3">
              <h2 className="thq-heading-2">
                {props.feature3Title ?? (
                  <Fragment>
                    <span className="features24-text4">Sustainable Sourcing</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
